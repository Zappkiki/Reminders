...
private RemindersSimpleCursorAdapter mCursorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            ...
            mDbAdapter.createReminder("Kupić samochód", true);
            mDbAdapter.createReminder("Zatankować auto", false);
            mDbAdapter.createReminder("Strzelnica w sobote", false);
            mDbAdapter.createReminder("Gra w csa", false);
            mDbAdapter.createReminder("Odśnieżyć podjazd", false);
            mDbAdapter.createReminder("Stworzyć profil na samoloty.pl", true);
